...
inline bool FeatureSet_EnforceNamingStyle_Parse(
    ...
    FeatureSet_EnforceNamingStyle* PROTOBUF_NONNULL value) {
...
/* @@protoc_insertion_point(class_definition:google.protobuf.FeatureSet) */ {
 ...
 public:
  ...
  static constexpr EnforceNamingStyle STYLE2024 =
      FeatureSet_EnforceNamingStyle_STYLE2024;
  static constexpr EnforceNamingStyle LEGACY_STYLE =
      FeatureSet_EnforceNamingStyle_LEGACY_STYLE;
